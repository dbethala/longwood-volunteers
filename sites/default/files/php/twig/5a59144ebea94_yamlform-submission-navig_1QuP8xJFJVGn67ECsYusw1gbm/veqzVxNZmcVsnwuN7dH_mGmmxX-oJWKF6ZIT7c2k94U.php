...
/* modules/yamlform/templates/yamlform-submission-navigation.html.twig */
class __TwigTemplate_27ab903222a7855fa31962177a671db1b4caf9949ccf510cb2daf10ecc31fead extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if ((($context["prev_url"] ?? null) || ($context["next_url"] ?? null))) {
            // line 17
            echo "  <nav id=\"yamlform-submission-navigation-";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, ($context["yamlform_id"] ?? null), "html", null, true));
            echo "\" class=\"yamlform-submission-navigation\" role=\"navigation\" aria-labelledby=\"yamlform-submission-label-";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, ($context["yamlform_id"] ?? null), "html", null, true));
            echo "\">
    <ul class=\"yamlform-submission-pager\">
      ";
            // line 19
            if (($context["prev_url"] ?? null)) {
                // line 20
                echo "        <li class=\"yamlform-submission-pager__item yamlform-submission-pager__item--previous\">
          <a href=\"";
                // line 21
      ...
      ";
            ...
            if (($context["next_url"] ?? null)) {
                // line 25
                echo "        <li class=\"yamlform-submission-pager__item yamlform-submission-pager__item--next\">
          <a href=\"";
                // line 26
...
";
    ...
    {
        return "modules/yamlform/templates/yamlform-submission-navigation.html.twig";
    }
    ...
    {
        return new Twig_Source("", "modules/yamlform/templates/yamlform-submission-navigation.html.twig", "/var/www/html/volunteer.longwoodgardens.org/modules/yamlform/templates/yamlform-submission-navigation.html.twig");
    }
}
